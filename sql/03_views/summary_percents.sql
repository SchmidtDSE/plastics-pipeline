...
SELECT
    ...
    with_total.netImportArticlesMT AS netImportArticlesMT,
    with_total.netImportFibersMT AS netImportFibersMT,
    with_total.netImportGoodsMT AS netImportGoodsMT,
    with_total.netImportResinMT AS netImportResinMT,
    ...
    with_total.consumptionTextileMT / with_total.totalConsumption AS consumptionTextilePercent,
...
FROM
    (
        SELECT
            ...
            (consumptionAgricultureMT + consumptionConstructionMT + consumptionElectronicMT + consumptionHouseholdLeisureSportsMT + consumptionPackagingMT + consumptionTransporationMT + consumptionTextileMT + consumptionOtherMT) AS totalConsumption,
