...
SELECT
    ...
    overview_net_imports.articlesNetMT AS articlesNetMT,
    overview_net_imports.fibersNetMT AS fibersNetMT,
    overview_net_imports.goodsNetMT AS goodsNetMT,
    overview_net_imports.resinNetMT AS resinNetMT,
