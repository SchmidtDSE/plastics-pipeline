...
SELECT
    ...
    with_product_trade.agricultureMT AS agricultureMT,
    with_product_trade.constructionMT AS constructionMT,
    with_product_trade.electronicMT AS electronicMT,
    with_product_trade.householdLeisureSportsMT AS householdLeisureSportsMT,
    with_product_trade.packagingMT AS packagingMT,
    with_product_trade.transportationMT AS transportationMT,
    with_product_trade.textileMT AS textileMT,
    with_product_trade.otherMT AS otherMT,
