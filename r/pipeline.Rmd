...
colnames(TB)[colnames(TB) == 'Sec_Waste'] <- 'Prim_W_EOL'

# All EOL  excluding recycling 
TB1<-MA5.1 %>% filter(EOL!="Recycling") %>% 
  select(Year_2, Region,EOL,Prim_W_EOL)
...
#ggplot(data = KD3, aes(x = Year_2, y = WasteGen)) +
  #geom_point()
...
#ggplot(data = KA3, aes(x = Year, y = PC_Sector)) +
  #geom_point()
...
#ggplot(data = TB2, aes(x = Year_2, y = Prim_W_EOL)) +
  #geom_point()
